<?php
//        $refresh = null;
//    if ($this->session->userdata('break') != null){
//        $refresh = 60;
//    }
//    $this->session->sess_destroy();
//
//    if ($this->session->userdata('break') != null){
//    foreach ($check_breaks as $break){
//        if ($break->break_type == $this->session->userdata('break')){
//            $refresh = 60;
//            $duration = $break->break_duration * 60;
//        }
//    }
//    $expected_time = $this->session->userdata('start') + $duration;
//
...
//            $break_type = $this->session->userdata('punch_type');
//            $note = '';
//            $request = 0;
//            $this->employee_attendance->endBreak($end,$date,$employee_id,$break_type);
//            $this->employee_attendance->timeOut($employee_id,$date,$end,$note,$request);
//
...
<script>
    ...
    $('#leave-request-tbl').DataTable();
    $('#sick-request-tbl').DataTable();
    $('#payslip-emp-tbl').DataTable();
