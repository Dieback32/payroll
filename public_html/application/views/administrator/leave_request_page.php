 <div class="panel-heading">
        <h3 class="panel-title"><i class="fas fa-plane"></i>&nbsp;Leave Request</h3>
    </div>
                ...
                <?php foreach ($employee_info as $info): ?>
                    <?php if ($req->employee_id == $info->employee_id): ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="" data-toggle="modal" data-target="#leaveModal" class="requestLeave" id="<?php echo $req->id?>"><i class="fas fa-thumbs-up fa-lg"></i></a>
                            </td>
                        </tr>
                    <?php endif;?>
                <?php endforeach; ?>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body" style="max-height: 400px; overflow-y: scroll;">
                <form action="<?php echo site_url();?>dashboard/requestLeaveApproved" method="post">
